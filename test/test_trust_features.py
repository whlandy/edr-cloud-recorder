...
def _assert(sel, assertion, expected, **param):
    return {"selector": {"sel": sel, "kind": "text"},
            "action": {"type": "Assert",
                       "param": {"assertion": assertion, "expected": expected, **param}}}
...
def test_blind_toggle_is_detected():
    ...
    node = node_features("step-0001", _click(
...
def test_positional_selector_is_detected():
    node = node_features("step-0001", _click(
        'locator("body > div:nth-of-type(9) > span.close")'))
...
def test_tautological_assertion_is_detected():
    ...
    node = node_features("step-0001", _assert(
...
def test_runtime_expected_assertion_is_marked():
    node = node_features("step-0001", _assert(
        'locator("tr").nth(1)', "text", "2026-08-19 01:29",
...
def test_template_coverage_only_counts_positional_steps():
    ...
    trace = _trace(
        {**_click('locator("#a")'),
         "recognition": {"templates": {"element": {}, "context": {}}}},
